...
import com.xdev.yourcompanion.check_connectivity.ConnectivityReceiver;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private final PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
            ...
            Toast.makeText(LoginActivity.this, "The code has been sent please wait ,the verification process is automatic", Toast.LENGTH_SHORT).show();
            verificationId = s;
        }
